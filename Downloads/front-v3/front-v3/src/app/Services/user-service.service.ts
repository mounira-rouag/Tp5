...
/** 
  verifyEmail(email: string): Observable<any> {
    ...
    verifyEmail(email: string): Observable<any> {
    return this.http.post<any>(`${environment.apiUrl}/users/reset-password?email=${email}`,email);}
  ...
  return this.http.put<any>( `${environment.apiUrl}/users/${userId}`, { responseType: 'text' })
   }
